...
public class Server  implements ActionListener{
	...
	//error in vertical and validate in main
	...
	Server(){ 
		...
		ImageIcon icon1 = new ImageIcon("C:\\Users\\Pradeep\\Downloads\\man.png");
	    ...
	    //userinfo.setBackground(new Color(184, 116, 252));
		...
		JLabel name = new JLabel("Person1");
